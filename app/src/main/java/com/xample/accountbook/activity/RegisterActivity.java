...
import com.xample.accountbook.Main3Activity;
...
//    EditText editTextName;
    ...
    private void register() {
        ...
        String prompt = editTextPassword.getText().toString();
        SharedPreferences sp = this.getSharedPreferences("accountbook", Context.MODE_PRIVATE);
